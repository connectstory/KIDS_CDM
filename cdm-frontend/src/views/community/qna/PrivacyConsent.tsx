...
export default function QnaPrivacyNoticeView() {
  ...
  return (
    <div className="w-full">
      ...
      <p className="text-base mb-4 mt-2">
        본 사이트를 이용하시며 궁금한 점, 불편한 점이나 개선사항에 대한 의견을
        부탁드립니다.
      </p>
      ...
      <div className="border rounded bg-white p-6 text-gray-700 text-base leading-relaxed">
        <p className="font-semibold mb-2">
          병원자료 분석네트워크 Q&A ‘개인정보 수집 동의 및 이용안내’
        </p>
        ...
        <ol className="list-decimal ml-5 space-y-3">
          <li>
            ...
            <br />
            한국의약품안전관리원은 병원자료 분석네트워크의 Q&A 관련 업무를 수행하기 위하여
            다음과 같이 개인정보를 수집, 이용합니다. 수집된 개인정보는 정해진 목적 이외의
            용도로는 사용되지 않으며, 수집 목적이 변경될 경우 사전에 정보 제공자에게
            알리고 다시 동의를 받을 예정입니다.
            <br />- 병원자료 분석네트워크 Q&A 관련 접수·처리·사후관리 서비스 제공
          </li>
      ...
      <div className="w-full flex justify-center mt-6 mb-6">
        <Button 
          variant="contained" 
          onClick={() => navigate(routes.COMMUNITY.QNA.WRITE)}
        >
          다음
        </Button>
      </div>
